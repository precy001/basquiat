...
import { createOrder, formatPrice, uploadPaymentReceipt } from "../utils/api";
            ...
            <div className="order-form" style={{ border: "none", padding: "0", marginTop: 24 }}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="receipt-upload">
                  ...
                  <small>Upload the receipt or screenshot for your payment. Optional.</small>
                  {receipt && <span className="receipt-name">{receipt.name}</span>}
                </div>
